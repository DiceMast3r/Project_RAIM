...
# Load the HTML file
with open("C:\\งาน\\Project_RAIM\\Pre-Project\\data\\routefinder_response.html", "r", encoding="utf-8") as file:
...
with open("C:\\งาน\\Project_RAIM\\Pre-Project\\data\\extracted_waypoints.csv", "w", newline="") as file:
    # Write the header
